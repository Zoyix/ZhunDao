package com.zhaohe.zhundao.gprinter;
...
public class PrinterConnectDialog extends ToolBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolBarNew("蓝牙连接", R.layout.dialog_port);
...
//					try {
//						mGpService.queryPrinterStatus(0, 1000, 0xfd);
