...
public class AsyncPostIdCard extends AsyncTask<String, Integer, String> {
    ...
    public AsyncPostIdCard(Context context, Handler handler, Dialog dialog, int request, String param) {
    ...
    protected String doInBackground(String... strings) {
        String path = (String) SPUtils.get(mContext, "HOST", Constant.HOST) + Constant.Url.PstAuthentication;
