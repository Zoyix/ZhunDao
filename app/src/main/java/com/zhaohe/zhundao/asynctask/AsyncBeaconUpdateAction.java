 ...
 */
public class AsyncBeaconUpdateAction extends AsyncTask<String, Integer, String> {
    ...
    public AsyncBeaconUpdateAction(Context context, Handler handler, int request, String param) {
    ...
    protected String doInBackground(String... strings) {
        String path = Constant.HOST + Constant.Url.UpdateBeacon;
