 ...
 */
public class AsyncSignListEdit extends AsyncTask<String, Integer, String> {
    ...
    public AsyncSignListEdit(Context context, Handler handler, int request, String Param) {
    ...
    protected String doInBackground(String... strings) {
        String path = Constant.HOST + Constant.Url.UpdateActivityList;
