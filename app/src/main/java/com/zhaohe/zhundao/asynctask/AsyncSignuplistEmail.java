 ...
 */
public class AsyncSignuplistEmail extends AsyncTask<String, Integer, String> {
...
private LoadToast lt;
    ...
    protected String doInBackground(String... strings) {
        String path = (String) SPUtils.get(mContext,"HOST",Constant.HOST) + Constant.Url.SendCheckInListByEmail;
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            msg.obj = result;
            System.out.println("发送签到列表到邮箱:" + result);
