package com.zhaohe.zhundao.asynctask.login;
...
public class AsyncBondPhone extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... strings) {
        String path = (String) SPUtils.get(mContext, "HOST", Constant.HOST) + Constant.Url.BondPhone;
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null) {
            ...
            msg.obj = result;
            System.out.println("绑定手机" + result);
