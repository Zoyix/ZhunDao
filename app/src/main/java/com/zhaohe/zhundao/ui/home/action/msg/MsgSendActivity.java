...
public class MsgSendActivity extends ToolBarActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, Toolbar.OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_signlist_msg_buy:
...
//                }
    ...
    private void successDialog() {
        ...
        NormalAlertDialog dialog = new NormalAlertDialog.Builder(MsgSendActivity.this)
                .setHeight(0.33f)  //屏幕高度*0.23
                .setWidth(0.85f)  //屏幕宽度*0.65
                .setTitleVisible(true)
                .setTitleText("提交成功")
                .setTitleTextColor(R.color.colorPrimary)
                .setContentText("1.审核通过，立即为您发送；\n2.审核不通过，返还短信条数；\n3.发送结果可在：个人中心→我的短信，查看；")
