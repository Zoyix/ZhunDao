...
public class ActionConsultActivity extends ToolBarActivity {
    private WebView webView;
    private String url = "http://m.zhundao.net/activity/ZbConsultList?id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_action_consult);
        initToolBar("咨询回复", R.layout.activity_action_consult);
        initView();
    }
