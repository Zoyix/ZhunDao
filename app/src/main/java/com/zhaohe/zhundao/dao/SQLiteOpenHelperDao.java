...
public class SQLiteOpenHelperDao extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase arg0, int arg1, int arg2) {
        ...
        arg0.execSQL("CREATE TABLE IF NOT EXISTS MyAccount(name varchar(20) , phone varchar(20), head varchar(20) ,accessKey varchar(20), status varchar(20) , primary key(phone) );");
