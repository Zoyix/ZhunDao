...
public class SocketHttpRequester {
     ...
     * </FORM>
     *
     * @param path   上传路径(注：避免使用localhost或127.0.0.1这样的路径测试，因为它会指向手机模拟器，你可以使用http://www.itcast.cn或http://ic_launcher.168.1.10:8080这样的路径测试)
    ...
    public static boolean post(String path, Map<String, String> params, FormFile[] files) throws Exception {
        ...
        //String userAgent = "User-Agent: " + AppContext.getHandSetInfo () + "\r\n";//添加来源
        //outStream.write (userAgent.getBytes ());
        String appKey = "AppKey: " + Constant.AppKey + "\r\n";//添加加密信息
        outStream.write(appKey.getBytes());
        ...
        if (reader.readLine().indexOf("200") == -1) {// 读取web服务器返回的数据，判断请求码是否为200，如果不是200，代表请求失败
            System.out.println("请求返回状态码：" + reader.readLine());
            return false;
        }
        outStream.flush();
        outStream.close();
